...
#This is the final stats code which contains codes for mean, median, mode.
...
# Normal Distribution
# Please read about the parameters for normal distribution 
...
# Please note you can ad any statement inthe string format for example prob. to score more than 67 
